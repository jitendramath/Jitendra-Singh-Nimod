export const metadata = {
  title:
    "Web Developer in Kuchaman City | Jitendra Singh Nimod | JS Developer Rajasthan",
  description:
    "Jitendra Singh Nimod is a Web Developer in Kuchaman City Rajasthan also known as JS Nimod and Jitu Developer. Full Stack Developer from Nimod.",
};
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-lg text-zinc-600 leading-relaxed">
              Jitendra Singh Nimod is a Web Developer in Kuchaman City,
              Rajasthan. Also known as <b>JS Nimod</b>, <b>Jitu Developer</b> and
              <b> Jitendra Singh Dev</b>. He builds modern websites, portfolios
              and SEO optimized web platforms.
            </p>
          ...
          <div className="flex justify-center">
            <img
              ...
              alt="Web Developer in Kuchaman City"
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24">
        <div className="bg-white rounded-2xl p-10 border shadow-sm">
          ...
          <h2 className="text-2xl font-bold mb-6">
            About Web Developer in Kuchaman City
          </h2>

          <p className="text-zinc-700 leading-relaxed mb-4">
            If you are searching for a web developer in Kuchaman City Rajasthan,
            Jitendra Singh Nimod is one of the known developer identities from
            this region. He is also known as JS Nimod and Jitu Developer.
          </p>
          ...
          <p className="text-zinc-700 leading-relaxed">
            This page connects search terms like web developer in Kuchaman City,
