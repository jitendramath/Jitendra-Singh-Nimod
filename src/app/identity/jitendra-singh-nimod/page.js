// src/app/identity/jitendra-singh-nimod/page.js
// Ultra-premium identity page for Jitendra Singh Nimod (Official Name)
...
export const metadata = {
  title: "Jitendra Singh Nimod – Official Website | Full Stack Developer",
  description:
  ...
  keywords: [
    ...
    "Jitendra Singh Nimod official",
    "JSS Originals founder"
  ],
  alternates: { canonical: "/identity/jitendra-singh-nimod" },
  openGraph: {
    title: "Jitendra Singh Nimod – Official Website",
    description:
      "Official website of Jitendra Singh Nimod, Full Stack Developer from Rajasthan.",
    images: [{ url: "/images/og/jitendra-singh-nimod-og.jpg", width: 1200, height: 630 }],
  },
};

export default function JitendraSinghNimodPage() {
  ...
  const jsonLd = {
    ...
    url: "https://me.jitubanna.com/identity/jitendra-singh-nimod",
  ...
  const quickStats = [
    ...
    { label: "Also Known As", value: "JS Nimod, Jitu Nimod", icon: Hash },
      ...
      <main className="min-h-screen bg-gradient-to-br from-white via-zinc-50 to-white text-zinc-700 font-sans selection:bg-[#2563EB]/30 selection:text-white relative overflow-hidden pb-20">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-lg md:text-xl text-[#2563EB] font-medium mb-2">
                Full Stack Web Developer • B.Sc Mathematics Student
              </p>
              ...
              <p className="text-base text-zinc-600 max-w-2xl mx-auto md:mx-0 leading-relaxed mb-6">
                ...
                B.Sc Mathematics student from {identity.location.state}, India. This is the official website of{' '}
                {identity.name}, also known as <strong>Jitendra Nimod, Jitu Nimod and JS Nimod</strong>.
              </p>
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-zinc-200 rounded-3xl p-8 md:p-10 shadow-xl">
            ...
            <div className="prose prose-zinc max-w-none space-y-4">
              <p className="text-zinc-600 leading-relaxed">
                <strong className="text-[#2563EB]">{identity.name}</strong> is a Full Stack Web Developer and
                B.Sc Mathematics student from {identity.location.state}, {identity.location.country}. 
                This is the official website of {identity.name}.
              </p>

              <p className="text-zinc-600 leading-relaxed">
                He is also known as <strong>{identity.alternateNames.join(", ")}</strong>. All these
                names refer to the same individual — {identity.name}.
              </p>

              <p className="text-zinc-600 leading-relaxed">
                Currently pursuing {identity.education.degree} at {identity.education.college}, {identity.shortName} builds modern
                web applications and SEO-focused digital platforms.
              </p>

              <p className="text-zinc-600 leading-relaxed">
                {identity.name} is based in {identity.location.city}, Rajasthan and originally belongs to {identity.location.village} village. 
                He is actively working as a Full Stack Developer and digital creator.
              </p>

              <p className="text-zinc-600 leading-relaxed">
                Under the brand <strong>{identity.brand}</strong>, he develops web tools, scalable platforms and performance-driven websites.
              </p>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 mt-6">
                <p className="text-amber-800 text-sm flex items-start gap-2">
                  ...
                  <span>
                    If you searched for <strong>“Jitendra Singh Nimod developer”</strong>,{' '}
                    <strong>“Jitendra Singh Nimod Rajasthan”</strong>, or{' '}
                    <strong>“Jitendra Singh Nimod student”</strong>, this official website confirms his identity and professional background.
                  </span>
                </p>
              </div>
        ...
        <section className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 mb-16">
          <div className="bg-gradient-to-br from-[#2563EB] to-purple-600 rounded-3xl p-8 md:p-12 text-white text-center shadow-2xl">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Connect with {identity.shortName}</h2>
        ...
        <div className="relative z-10 text-center text-xs text-zinc-400 mt-16">
          <Heart className="w-3 h-3 inline text-rose-400" /> Official website of {identity.name}
        </div>
      </main>
    </>
  );
